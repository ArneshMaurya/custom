...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "training2ycommwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "training2ycommwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "training2ycommwebservices.oauth2.tokenUrl";

	private static final String DESC = "training2ycommwebservices.v1.description";
	private static final String TITLE = "training2ycommwebservices.v1.title";
	private static final String VERSION = "training2ycommwebservices.v1.version";
